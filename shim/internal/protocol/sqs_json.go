...
// ParseSQSJSONRequest, EncodeSQSJSONResponse, EncodeSQSJSONError foram
// movidos para common.go (refactor/kiss-dry-pass-1 — compartilhados com
// SNS, formato byte-a-byte idêntico entre os dois serviços).
//
// Helpers de extração de Attributes/Tags/MessageAttributes específicos
// do JSON 1.0 ficam aqui (são SQS-only nas features, mas codificados
// em JSON compatível com a library message_attribute.go).
